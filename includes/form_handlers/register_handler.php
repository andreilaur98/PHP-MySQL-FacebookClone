...
if(isset($_POST['reg_user'])){
    ...
    if(empty($error_array)){
        ...
        $query = "INSERT INTO users (first_name, last_name, username, email, dob, gender, password, profile_pic, cover_pic) VALUES ('$fname', '$lname', '$username', '$email', '$dob', '$gender', '$password', '$profile_pic', '$cover_pic')";
