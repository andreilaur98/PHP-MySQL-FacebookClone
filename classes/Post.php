...
class Post{
    ...
    public function submitPost($body, $user_to, $imageName){
        ...
        if($check_empty != ""){
            ...
            $query = "INSERT INTO posts (body, user_to, added_by,date_added,image, deleted,user_closed) VALUES('$body', '$user_to','$added_by', '$date_added','$imageName', 'no','no')";
